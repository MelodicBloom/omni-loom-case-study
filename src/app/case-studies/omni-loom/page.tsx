        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            {data.skills.map((skill) => (
              <div
                key={typeof skill === 'string' ? skill : skill.domain}
                className="rounded-lg border border-border bg-card p-5 shadow-sm hover:bg-accent/40 transition-colors"
              >
                <p className="text-sm font-medium text-card-foreground">
                  {typeof skill === 'string' ? skill : skill.domain}
                </p>
              </div>
            ))}
          </div>
