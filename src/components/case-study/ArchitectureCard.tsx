        ...
        <div>
          ...
          <ul className="space-y-0.5">
            {block.inputs.map((input) => (
              <li key={input} className="text-[#94A3B8]">{input}</li>
            ))}
          </ul>
        </div>
        <div>
          ...
          <ul className="space-y-0.5">
            {block.outputs.map((output) => (
              <li key={output} className="text-[#94A3B8]">{output}</li>
            ))}
          </ul>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-1">
          {block.constraints.map((c) => (
            <span key={c} className="text-[10px] px-2 py-0.5 rounded border border-[#263244] text-[#94A3B8] font-mono">
              {c}
            </span>
          ))}
        </div>
